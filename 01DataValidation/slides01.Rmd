...
- Data validation
    - Introduction and Formal approach
    - Practical approach
    - Introduction to rule management
...
### Algebra of validation functions

- If $v$ and $w$ are validation functions then so are $v\land w$, where
$(v\land w)(S)\equiv v(S)\land w(S)$.
- If $v$ is a validation function then so is $\lnot v$, where $(\lnot v)(S) \equiv \lnot v(S)$

### Question

Is $v\lor w$, where $(v\lor w)(S) = v(S)\lor w(S)$ also a validation function?
